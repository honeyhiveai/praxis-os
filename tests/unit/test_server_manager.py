...
class TestRestartServer:
    ...
    @patch("time.sleep")
    def test_restart_server_success(
        self, mock_sleep, mock_popen, mock_run, server_manager
    ):
    ...
    @patch("subprocess.Popen")
    @patch("time.sleep")
    def test_restart_server_start_failure(
        self, mock_sleep, mock_popen, mock_run, server_manager
    ):
...
class TestWaitForServerReady:
    ...
    @patch("subprocess.run")
    @patch("time.sleep")
    def test_wait_for_server_ready_immediate(
        self, mock_sleep, mock_run, server_manager
    ):
    ...
    @patch("time.sleep")
    @patch("time.time")
    def test_wait_for_server_ready_eventually(
        self, mock_time, mock_sleep, mock_run, server_manager
    ):
