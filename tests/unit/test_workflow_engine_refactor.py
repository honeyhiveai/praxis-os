...
class TestWorkflowEngineSessionFactory:
    ...
    def test_get_session_raises_on_not_found(
    ...
    def test_get_session_loads_metadata(
        self, engine, mock_state_manager, sample_state
    ):
...
class TestDelegationToSession:
    ...
    def test_complete_phase_delegates(
        self, engine, mock_state_manager, sample_state
    ):
...
class TestDynamicWorkflowIntegration:
    ...
    def test_dynamic_workflow_creates_registry(
        ...
        tasks_file.write_text("""# Test Spec Tasks
...
class TestMetadataLoading:
    ...
    def test_load_workflow_metadata_from_file(
        self, engine, mock_workflows_path
    ):
