...
class TestGenerateUpgradeSummary:
    ...
    def test_generate_upgrade_summary_creates_file(self, report_generator, mock_workflow_state):
    ...
    def test_generate_upgrade_summary_content(self, report_generator, mock_workflow_state):
    ...
    def test_generate_upgrade_summary_with_artifacts(self, report_generator, mock_workflow_state):
...
class TestIntegration:
    ...
    def test_generate_all_reports(self, report_generator, mock_workflow_state, tmp_path):
