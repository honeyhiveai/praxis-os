"""
Integration test for prAxIs OS Upgrade Workflow registration and discovery.

Tests that the workflow engine can discover and load the praxis_os_upgrade_v1 workflow.
"""
...
class TestWorkflowRegistration:
    ...
    def test_workflow_metadata_file_exists(self):
        """Test that metadata.json file exists for praxis_os_upgrade_v1."""
        workflows_path = Path(__file__).parent.parent.parent / "universal" / "workflows"
        metadata_path = workflows_path / "praxis_os_upgrade_v1" / "metadata.json"
    ...
    def test_metadata_json_is_valid(self):
        ...
        assert metadata["workflow_type"] == "praxis_os_upgrade_v1"
    ...
    def test_all_phase_files_exist(self):
        ...
        for phase in metadata["phases"]:
            phase_file = workflows_path / "praxis_os_upgrade_v1" / phase["file"]
    ...
    def test_workflow_engine_can_load_metadata(self, workflow_engine):
        """Test that WorkflowEngine can load praxis_os_upgrade_v1 metadata."""
        metadata = workflow_engine.load_workflow_metadata("praxis_os_upgrade_v1")
        ...
        assert (
            ...
            == "AI-guided prAxIs OS upgrade with validation and rollback"
        )
        assert metadata.total_phases == 6
...
class TestWorkflowStructure:
    ...
    def test_phases_directory_exists(self):
        ...
        workflows_path = Path(__file__).parent.parent.parent / "universal" / "workflows"
        phases_dir = workflows_path / "praxis_os_upgrade_v1" / "phases"
    ...
    def test_supporting_docs_directory_exists(self):
        ...
        workflows_path = Path(__file__).parent.parent.parent / "universal" / "workflows"
        docs_dir = workflows_path / "praxis_os_upgrade_v1" / "supporting-docs"
    ...
    def test_readme_exists(self):
        ...
        workflows_path = Path(__file__).parent.parent.parent / "universal" / "workflows"
        readme = workflows_path / "praxis_os_upgrade_v1" / "README.md"

        assert readme.exists()

        content = readme.read_text()
        assert "prAxIs OS Upgrade Workflow" in content
