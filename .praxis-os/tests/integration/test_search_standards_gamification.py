...
def mock_rag_engine():
    ...
    mock_result = Mock()
    mock_result.chunks = [
        {"content": "Test content 1", "file_path": "test/file1.md", "section_header": "Section 1", "tokens": 50},
        {"content": "Test content 2", "file_path": "test/file2.md", "section_header": "Section 2", "tokens": 40},
    ]
...
async def test_progressive_stats_across_queries(search_standards_func):
    ...
    with patch("mcp_server.server.tools.rag_tools.extract_session_id_from_context") as mock_extract:
