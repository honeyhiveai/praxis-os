...
class IndexBuilder:
    ...
    def __init__(
        ...
        Args:
            ...
            standards_path: Path to prAxIs OS standards directory
            usage_path: Path to prAxIs OS usage documentation directory (optional)
...
def main():
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Path to prAxIs OS usage docs (default: auto-detect from standards-path)",
    )
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Path to prAxIs OS workflows (default: auto-detect from standards-path)",
    )
