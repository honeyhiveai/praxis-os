...
- Designing new classes → `pos_search(content_type="standards", query="how to design maintainable classes")`
- Code review feedback about coupling → `pos_search(content_type="standards", query="reducing code coupling")`
- Making code testable → `pos_search(content_type="standards", query="dependency injection pattern")`
- Class doing too many things → `pos_search(content_type="standards", query="single responsibility principle")`
- Adding features breaks existing code → `pos_search(content_type="standards", query="open closed principle")`
- Inheritance causing bugs → `pos_search(content_type="standards", query="liskov substitution")`
- Interface has unused methods → `pos_search(content_type="standards", query="interface segregation")`
...
pos_search(content_type="standards", query="how to design maintainable classes")
pos_search(content_type="standards", query="class design best practices")
pos_search(content_type="standards", query="dependency injection pattern")
```
...
pos_search(content_type="standards", query="reducing code coupling")
pos_search(content_type="standards", query="single responsibility principle")
pos_search(content_type="standards", query="interface segregation")
```
...
pos_search(content_type="standards", query="open closed principle")
pos_search(content_type="standards", query="liskov substitution")
pos_search(content_type="standards", query="making code testable")
```
...
pos_search(content_type="standards", query="dependency inversion")
pos_search(content_type="standards", query="how to mock dependencies")
```
...
pos_search(content_type="standards", query="clean architecture hexagonal")

# For API design
pos_search(content_type="standards", query="API design best practices")

# For dependency management
pos_search(content_type="standards", query="dependency injection containers")

# For testing strategy
pos_search(content_type="standards", query="test pyramid testing levels")
```
...
pos_search(content_type="standards", query="python dependency injection decorators")
pos_search(content_type="standards", query="python abstract base classes protocols")

# Go-specific SOLID
pos_search(content_type="standards", query="go interfaces composition")

# Rust-specific SOLID  
pos_search(content_type="standards", query="rust traits generics")
```
