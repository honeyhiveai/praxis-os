...
|-----------|---------------|
| **Git operations** | `pos_search(content_type="standards", query="git safety rules")` |
| **Revert changes** | `pos_search(content_type="standards", query="how to revert file changes")` |
| **Forbidden commands** | `pos_search(content_type="standards", query="forbidden git commands")` |
| **git reset** | `pos_search(content_type="standards", query="can AI use git reset")` |
| **git push force** | `pos_search(content_type="standards", query="git push force")` |
| **Safe git operations** | `pos_search(content_type="standards", query="safe git operations")` |
| **Data loss** | `pos_search(content_type="standards", query="git data loss")` |
| **Branch operations** | `pos_search(content_type="standards", query="AI delete git branch")` |
...
1. **Start with git rules** → `pos_search(content_type="standards", query="git safety rules")` (this document)
...
3. **Learn credential protection** → `pos_search(content_type="standards", query="credential file protection")` → `standards/ai-safety/credential-file-protection.md`
4. **Understand security** → `pos_search(content_type="standards", query="security patterns")` → `standards/security/security-patterns.md`
