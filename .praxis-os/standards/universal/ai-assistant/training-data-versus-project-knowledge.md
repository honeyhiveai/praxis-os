...
✅ Agent: pos_search(content_type="standards", query="how does authentication work in this project")
...
pos_search(content_type="standards", query="how to add X in this project")
...
def handle_recognition():
    ...
    pos_search(content_type="standards", query="how does this work here")
...
Agent: pos_search(content_type="standards", query="authentication patterns in this project")
...
Agent: pos_search(content_type="standards", query="database configuration patterns")
...
Step 1: Standards (prAxIs OS base → Universal CS → Project-specific)
  → pos_search(content_type="standards", query="authentication patterns in this project")
  → pos_search(content_type="standards", query="OAuth2 implementation")
