...
- Query: `pos_search(content_type="standards", query="how to create specification")` to find workflow
...
- Query: `pos_search(content_type="standards", query="how to execute specification")` to find workflow
...
1. **Query for domain knowledge to inform design discussion:**
   ```python
   pos_search(content_type="standards", query="how to [domain] best practices")
   pos_search(content_type="standards", query="[technology] patterns")
   ```
...
1. **Query to discover how to create specification:**
   ```python
   pos_search(content_type="standards", query="how to create specification")
   ```
...
1. **Query to discover how to implement from spec:**
   ```python
   pos_search(content_type="standards", query="how to execute specification")
   ```
...
- [ ] Queried: `pos_search(content_type="standards", query="how to create specification")`
...
- [ ] Queried: `pos_search(content_type="standards", query="how to execute specification")`
...
pos_search(content_type="standards", query="authentication patterns best practices")
...
|-----------|---------------|
| **User says "build X"** | `pos_search(content_type="standards", query="user wants me to build something what do I do")` |
| **Not sure where to start** | `pos_search(content_type="standards", query="user says build authentication where do I start")` |
| **Wondering if you should code now** | `pos_search(content_type="standards", query="should I start coding immediately")` |
| **Need to know the approach** | `pos_search(content_type="standards", query="what's the development approach")` |
| **Confused about discuss vs spec** | `pos_search(content_type="standards", query="do I start with spec or discussion")` |
| **Don't know when to use workflow** | `pos_search(content_type="standards", query="am I supposed to use workflow or talk")` |
| **User gave requirements** | `pos_search(content_type="standards", query="user gave requirements should I write code now")` |
| **Starting new feature** | `pos_search(content_type="standards", query="what do I do first when user wants feature")` |
...
1. **Start with development process** → `pos_search(content_type="standards", query="prAxIs OS development process")` (this document)
2. **Learn about spec creation** → `pos_search(content_type="standards", query="how to create specification")`
3. **Learn about spec execution** → `pos_search(content_type="standards", query="how to execute specification")`
4. **Understand operating model** → `pos_search(content_type="standards", query="prAxIs OS operating model human AI partnership")`

**By Phase:**

**Phase 1 (Design):**
- Query: `pos_search(content_type="standards", query="[domain] architecture patterns")`
- Query: `pos_search(content_type="standards", query="[technology] best practices")`

**Phase 2 (Spec):**
- Query: `pos_search(content_type="standards", query="how to create specification")`
- Query: `pos_search(content_type="standards", query="spec structure requirements")`

**Phase 3 (Implementation):**
- Query: `pos_search(content_type="standards", query="how to execute specification")`
- Query: `pos_search(content_type="standards", query="production code quality standards")`
