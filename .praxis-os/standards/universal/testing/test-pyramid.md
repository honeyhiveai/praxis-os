...
- Planning test strategy → `pos_search(content_type="standards", query="test pyramid ratios")`
- Too many slow tests → `pos_search(content_type="standards", query="e2e testing best practices")`
- Deciding what to test → `pos_search(content_type="standards", query="unit vs integration testing")`
- Test suite too slow → `pos_search(content_type="standards", query="fast test suite")`
- Code coverage targets → `pos_search(content_type="standards", query="test coverage strategy")`
...
pos_search(content_type="standards", query="test pyramid ratios")
pos_search(content_type="standards", query="what to test with unit tests")
pos_search(content_type="standards", query="test coverage targets")
```
...
pos_search(content_type="standards", query="fast test suite optimization")
pos_search(content_type="standards", query="test speed targets")
pos_search(content_type="standards", query="unit vs integration testing")
```
...
pos_search(content_type="standards", query="when to write integration tests")
pos_search(content_type="standards", query="e2e testing best practices")
pos_search(content_type="standards", query="test doubles mocking")
```
...
pos_search(content_type="standards", query="test pyramid anti-patterns")
pos_search(content_type="standards", query="testing best practices")
```
...
pos_search(content_type="standards", query="test doubles mocking stubs fakes")

# For integration testing patterns
pos_search(content_type="standards", query="integration testing database")

# For E2E testing guidance
pos_search(content_type="standards", query="end to end testing selenium")

# For test quality checks
pos_search(content_type="standards", query="production code checklist testing")
```
...
```python
# Python testing
pos_search(content_type="standards", query="pytest unittest python testing")

# Go testing
pos_search(content_type="standards", query="go test table tests benchmarks")

# JavaScript testing
pos_search(content_type="standards", query="jest mocha cypress javascript testing")

# Java testing
pos_search(content_type="standards", query="junit mockito java testing")
```
