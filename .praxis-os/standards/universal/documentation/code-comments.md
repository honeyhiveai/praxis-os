...
|-----------|---------------|
| **Writing comments** | `pos_search(content_type="standards", query="code comments")` |
| **Comment best practices** | `pos_search(content_type="standards", query="comment best practices")` |
| **Deciding to comment** | `pos_search(content_type="standards", query="when to comment")` |
| **Documentation comments** | `pos_search(content_type="standards", query="docstrings JSDoc")` |
| **TODO vs FIXME** | `pos_search(content_type="standards", query="TODO FIXME")` |
| **Commented-out code** | `pos_search(content_type="standards", query="commented out code")` |
| **Maintaining comments** | `pos_search(content_type="standards", query="maintain comments")` |
| **Comment anti-patterns** | `pos_search(content_type="standards", query="comment anti-patterns")` |
...
1. **Start with comments** → `pos_search(content_type="standards", query="code comments")` (this document)
2. **API docs** → `pos_search(content_type="standards", query="API documentation")` → `standards/documentation/api-documentation.md`
3. **README** → `pos_search(content_type="standards", query="README templates")` → `standards/documentation/readme-templates.md`

**By Category:**

**Documentation:**
- `standards/documentation/api-documentation.md` - Documenting APIs → `pos_search(content_type="standards", query="API documentation")`
...
**Architecture:**
- `standards/architecture/solid-principles.md` - Single Responsibility (helps code clarity) → `pos_search(content_type="standards", query="SOLID principles")`
