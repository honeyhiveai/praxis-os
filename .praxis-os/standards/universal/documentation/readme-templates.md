...
|-----------|---------------|
| **Creating new README** | `pos_search(content_type="standards", query="README template")` |
| **Improving README** | `pos_search(content_type="standards", query="README best practices")` |
| **Quick Start section** | `pos_search(content_type="standards", query="Quick Start guide")` |
| **Project documentation** | `pos_search(content_type="standards", query="project documentation")` |
| **Installation instructions** | `pos_search(content_type="standards", query="installation instructions")` |
| **Usage examples** | `pos_search(content_type="standards", query="usage examples README")` |
| **README structure** | `pos_search(content_type="standards", query="README structure")` |
| **README by project type** | `pos_search(content_type="standards", query="README template library")` or similar |
| **README anti-patterns** | `pos_search(content_type="standards", query="README anti-patterns")` |
...
1. **Start with README** → `pos_search(content_type="standards", query="README template")` (this document)
2. **Code comments** → `pos_search(content_type="standards", query="code comments")` → `standards/documentation/code-comments.md`
3. **API docs** → `pos_search(content_type="standards", query="API documentation")` → `standards/documentation/api-documentation.md`

**By Category:**

**Documentation:**
- `standards/documentation/code-comments.md` - Commenting practices → `pos_search(content_type="standards", query="code comments")`
- `standards/documentation/api-documentation.md` - API documentation → `pos_search(content_type="standards", query="API documentation")`

**Usage Guides:**
- `usage/creating-specs.md` - Creating specifications → `pos_search(content_type="standards", query="how to create specs")`

**AI Safety:**
- `standards/ai-safety/production-code-checklist.md` - Documentation requirements → `pos_search(content_type="standards", query="production code checklist")`
