...
|-----------|---------------|
| **Building an API** | `pos_search(content_type="standards", query="API documentation")` |
| **Writing API reference** | `pos_search(content_type="standards", query="API reference documentation")` |
| **Getting started guide** | `pos_search(content_type="standards", query="getting started guide")` |
| **Documenting authentication** | `pos_search(content_type="standards", query="authentication documentation")` |
| **Error code documentation** | `pos_search(content_type="standards", query="error codes documentation")` |
| **API examples** | `pos_search(content_type="standards", query="API examples")` |
| **Interactive documentation** | `pos_search(content_type="standards", query="interactive API docs")` |
| **API versioning** | `pos_search(content_type="standards", query="API versioning")` |
| **OpenAPI/Swagger** | `pos_search(content_type="standards", query="OpenAPI Swagger")` |
...
1. **Start here** → `pos_search(content_type="standards", query="API documentation")` (this document)
2. **Code comments** → `pos_search(content_type="standards", query="code comments")` → `standards/documentation/code-comments.md`
3. **README** → `pos_search(content_type="standards", query="README templates")` → `standards/documentation/readme-templates.md`
4. **Security** → `pos_search(content_type="standards", query="security patterns")` → `standards/security/security-patterns.md`

**By Category:**

**Documentation:**
- `standards/documentation/code-comments.md` - Inline code documentation → `pos_search(content_type="standards", query="code comments")`
- `standards/documentation/readme-templates.md` - Project README structure → `pos_search(content_type="standards", query="README templates")`

**Architecture:**
- `standards/architecture/api-design-principles.md` - API design best practices → `pos_search(content_type="standards", query="API design")`

**Security:**
- `standards/security/security-patterns.md` - Securing APIs → `pos_search(content_type="standards", query="security patterns")`

**Testing:**
- `standards/testing/integration-testing.md` - Testing API endpoints → `pos_search(content_type="standards", query="integration testing")`

**AI Safety:**
- `standards/ai-safety/production-code-checklist.md` - Documentation requirements for production → `pos_search(content_type="standards", query="production code checklist")`
