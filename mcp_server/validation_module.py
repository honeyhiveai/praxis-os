...
class ValidationModule:
    ...
    def validate_source_repo(source_path: str) -> Dict:
        ...
        Checks:
        - Path exists
        - Is praxis-os-enhanced repository
        ...
        # Check is praxis-os-enhanced repo
        if not (source / "mcp_server").exists():
            result["errors"].append("Not an praxis-os-enhanced repository")
            return result
    ...
    @staticmethod
    def validate_target_structure(target_path: str = ".praxis-os/") -> Dict:
        """
    ...
    def check_disk_space(
        path: str = ".praxis-os/", required_multiplier: float = 2.0
    ) -> Dict:
        """
    ...
    def check_for_concurrent_upgrades(
        lock_file: str = ".praxis-os/.upgrade-lock",
    ) -> Dict:
        """
    ...
    def validate_workflow_not_in_progress(
        state_dir: str = ".praxis-os/.cache/state/",
    ) -> bool:
        """
