...
class BrowserTool(ActionDispatchMixin):
    ...
    async def _handle_navigate(
        ...
        **kwargs
        ...
        result: Dict[str, Any] = await self.browser_manager.navigate(
    ...
    async def _handle_screenshot(
        ...
        **kwargs
        ...
        result: Dict[str, Any] = await self.browser_manager.screenshot(
            session_id=browser_session_id,
            browser_type=browser_type,
            headless=headless,
    ...
    async def _handle_console(
        ...
        **kwargs
        ...
        result: Dict[str, Any] = await self.browser_manager.get_console_messages(
            session_id=browser_session_id,
            browser_type=browser_type,
            headless=headless,
        )
    ...
    async def _handle_query(
        ...
        **kwargs
        ...
        result: Dict[str, Any] = await self.browser_manager.query(
            session_id=browser_session_id,
            browser_type=browser_type,
            headless=headless,
            selector=selector,
    ...
    async def _handle_evaluate(
        ...
        **kwargs
        ...
        result: Dict[str, Any] = await self.browser_manager.evaluate(
            session_id=browser_session_id,
            browser_type=browser_type,
            headless=headless,
            script=script,
    ...
    async def _handle_get_cookies(
        ...
        **kwargs
        ...
        """Get all cookies."""
        result: Dict[str, Any] = await self.browser_manager.get_cookies(
            session_id=browser_session_id,
            browser_type=browser_type,
            headless=headless,
            cookie_name=cookie_name,
    ...
    async def _handle_get_local_storage(
        ...
        **kwargs
        ...
        result: Dict[str, Any] = await self.browser_manager.get_local_storage(
            session_id=browser_session_id,
            browser_type=browser_type,
            headless=headless,
            key=storage_key,
    ...
    async def _handle_click(
        ...
        **kwargs
        ...
        result: Dict[str, Any] = await self.browser_manager.click(
            session_id=browser_session_id,
            browser_type=browser_type,
            headless=headless,
            selector=selector,
    ...
    async def _handle_type(
        ...
        **kwargs
        ...
        result: Dict[str, Any] = await self.browser_manager.type(
            session_id=browser_session_id,
            browser_type=browser_type,
            headless=headless,
            selector=selector,
    ...
    async def _handle_fill(
        ...
        **kwargs
        ...
        result: Dict[str, Any] = await self.browser_manager.fill(
            session_id=browser_session_id,
            browser_type=browser_type,
            headless=headless,
            selector=selector,
    ...
    async def _handle_select(
        ...
        **kwargs
        ...
        result: Dict[str, Any] = await self.browser_manager.select(
            session_id=browser_session_id,
            browser_type=browser_type,
            headless=headless,
            selector=selector,
    ...
    async def _handle_wait(
        ...
        **kwargs
        ...
        result: Dict[str, Any] = await self.browser_manager.wait(
            session_id=browser_session_id,
            browser_type=browser_type,
            headless=headless,
            selector=selector,
    ...
    async def _handle_emulate_media(
        ...
        **kwargs
        ...
        result: Dict[str, Any] = await self.browser_manager.emulate_media(
            session_id=browser_session_id,
            browser_type=browser_type,
            headless=headless,
            color_scheme=color_scheme,
    ...
    async def _handle_viewport(
        ...
        **kwargs
        ...
        result: Dict[str, Any] = await self.browser_manager.set_viewport(
            session_id=browser_session_id,
            browser_type=browser_type,
            headless=headless,
    ...
    async def _handle_set_cookies(
        ...
        **kwargs
        ...
        result: Dict[str, Any] = await self.browser_manager.set_cookies(
            session_id=browser_session_id,
            browser_type=browser_type,
            headless=headless,
            cookies=cookies,
    ...
    async def _handle_run_test(
        ...
        **kwargs
        ...
        result: Dict[str, Any] = await self.browser_manager.run_test(
            session_id=browser_session_id,
            browser_type=browser_type,
            headless=headless,
            test_file=test_file,
    ...
    async def _handle_intercept_network(
        ...
        **kwargs
        ...
        result: Dict[str, Any] = await self.browser_manager.intercept_network(
            session_id=browser_session_id,
            browser_type=browser_type,
            headless=headless,
    ...
    async def _handle_new_tab(
        ...
        **kwargs
        ...
        """Create new tab."""
        result: Dict[str, Any] = await self.browser_manager.new_tab(
            session_id=browser_session_id,
            browser_type=browser_type,
            headless=headless,
            url=new_tab_url,
    ...
    async def _handle_switch_tab(
        ...
        **kwargs
        ...
        result: Dict[str, Any] = await self.browser_manager.switch_tab(
            session_id=browser_session_id,
            browser_type=browser_type,
            headless=headless,
            tab_id=tab_id,
    ...
    async def _handle_close_tab(
        ...
        **kwargs
        ...
        """Close tab by ID."""
        result: Dict[str, Any] = await self.browser_manager.close_tab(
            session_id=browser_session_id,
            browser_type=browser_type,
            headless=headless,
            tab_id=tab_id,
    ...
    async def _handle_list_tabs(
        ...
        **kwargs
        ...
        """List all tabs."""
        result: Dict[str, Any] = await self.browser_manager.list_tabs(
            session_id=browser_session_id,
            browser_type=browser_type,
            headless=headless,
        )
    ...
    async def _handle_upload_file(
        ...
        **kwargs
        ...
        result: Dict[str, Any] = await self.browser_manager.upload_file(
            session_id=browser_session_id,
            browser_type=browser_type,
            headless=headless,
            selector=selector,
    ...
    async def _handle_download_file(
        ...
        **kwargs
        ...
        result: Dict[str, Any] = await self.browser_manager.download_file(
            session_id=browser_session_id,
            browser_type=browser_type,
            headless=headless,
    ...
    async def _handle_close(
        ...
        **kwargs
        ...
        result: Dict[str, Any] = await self.browser_manager.close_session(
            session_id=browser_session_id,
            browser_type=browser_type,
            headless=headless,
        )
