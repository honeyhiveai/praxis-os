...
response = start_workflow(
    ...
    target_file=".agent-os/specs/2025-10-06-dynamic-workflow-session-refactor",
    options={"spec_path": ".agent-os/specs/2025-10-06-dynamic-workflow-session-refactor"}
)
...
- Access to .agent-os/ directory structure
